      ...
      <div className="min-h-screen bg-neutral-950 px-4 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <button className="w-full px-4 py-3 bg-purple-500 text-neutral-950 font-semibold rounded-lg hover:bg-purple-400 transition">
                  Add Lead Manually
                </button>
          ...
          <div className="mt-12 bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-700 rounded-lg p-8">
            ...
            <button className="px-6 py-2 bg-purple-500 text-neutral-950 font-semibold rounded-lg hover:bg-purple-400 transition">
              Learn More
            </button>
          </div>
        </div>

...
export default function LuxeLeadProMobileApp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50" style={{ paddingBottom: '80px' }}>
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-[#D4AF37] to-pink-500 text-white px-4 py-4 shadow-lg">
        <div className="flex justify-between items-center max-w-md mx-auto">
          <div>
            <h1 className="text-2xl font-bold font-serif">LuxeLeadPro</h1>
            <p className="text-xs text-slate-300">AI Lead Scoring</p>
          </div>
          <div className="text-right text-sm">
            <p className="text-slate-300">Wed, Mar 18</p>
        ...
        {activeTab === 'home' && (
          <>
            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
              ...
              <div className="bg-gradient-to-br from-[#D4AF37]/5 to-pink-100 rounded-lg p-4 text-center border border-[#D4AF37]/20">
                <p className="text-2xl font-bold text-[#D4AF37]">8.2%</p>
                <p className="text-xs text-[#D4AF37] mt-1">Conversion</p>
              </div>
              <div className="bg-gradient-to-br from-[#D4AF37]/5 to-[#D4AF37]/10 rounded-lg p-4 text-center border border-[#D4AF37]/20">
                <p className="text-2xl font-bold text-[#D4AF37]">$2.8M</p>
                <p className="text-xs text-[#D4AF37] mt-1">Total MRR</p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              {hotLeads.slice(0, 3).map((lead) => (
                <div 
                  key={lead.id}
                  className="bg-white rounded-lg border-l-4 border-[#D4AF37] p-4 shadow-sm hover:shadow-md transition"
                >
              ...
              {hotLeads.map((lead) => (
                <div 
                  ...
                  className={`bg-white rounded-lg p-4 border-l-4 ${
                    lead.score >= 80 ? 'border-red-500' : lead.score >= 60 ? 'border-[#D4AF37]' : 'border-blue-500'
                  } shadow-sm`}
                >
                  <div className="flex justify-between mb-2">
                    ...
                    <span className={`text-xs font-bold px-2 py-1 rounded ${
                      ...
                      lead.score >= 60 ? 'bg-[#D4AF37]/10 text-[#D4AF37]' :
          ...
          <>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 mb-6 border border-blue-200">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                ...
                <p className="font-semibold text-[#D4AF37] mb-1">{briefing.topLead.name}</p>

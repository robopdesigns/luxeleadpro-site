  ...
  return (
    ...
    <div className="login-layout">
      <div className="brand-panel">
        ...
        <h2>Command <span className="accent">Center</span><br/>awaits.</h2>
        <p className="sub">Access your owner dashboard to manage leads, reps, tasks, and track your business performance.</p>
        <div className="login-stats">
          <div className="login-stat"><div className="value gold">10</div><div className="label">Total Leads</div></div>
          <div className="login-stat"><div className="value">15</div><div className="label">Active Tasks</div></div>
          <div className="login-stat"><div className="value gold">$0</div><div className="label">MRR</div></div>
        </div>
      </div>
      <div className="form-panel">
        <h2>Owner Dashboard</h2>
        <p className="form-sub">Access your command center</p>
        {error && <div className="error-msg">{error}</div>}
        <form onSubmit={handleSubmit}>
          <div className="form-group"><label>Dashboard Password</label><input type="password" required value={password} onChange={e => setPassword(e.target.value)} placeholder="Enter your password" /></div>

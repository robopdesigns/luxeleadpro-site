...
export default function ManagerLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (role && role !== "manager" && role !== "admin") { setError("This account is not a manager account"); setLoading(false); return; }
      router.push("/manager");
  ...
  return (
    ...
    <div className="login-layout">
      <div className="brand-panel">
        ...
        <h2>Welcome back.<br/>Your <span className="accent">team</span> is waiting.</h2>
        <p className="sub">Sign in to manage your agents, track performance, and grow your luxury real estate operation.</p>
        <div className="login-stats">
          <div className="login-stat"><div className="value gold">5</div><div className="label">Active Agents</div></div>
          <div className="login-stat"><div className="value">$47K</div><div className="label">Team Revenue</div></div>
          <div className="login-stat"><div className="value gold">89%</div><div className="label">Retention Rate</div></div>
        </div>
      </div>
      <div className="form-panel">
        <h2>Manager Login</h2>
        <p className="form-sub">Access your team management dashboard</p>
        ...
        <div className="form-footer"><a href="/agent/login">Are you an agent? Agent login</a><br/><br/><a href="/" style={{ color: '#718096' }}>← Back to Home</a></div>
      </div>
    </div></>
  );
}
